...
function addTileLayers(map) {
	/* CHANGES map.js to playhouse_map.js 
   Change county_coverage layer from zoom Z6-16 version to Z8-18 version
   getREEDLayerURL('EREED_gis_counties_base'), {
*/
  let county_coverage = L.tileLayer(
    getREEDLayerURL('EREED_gis_counties_base_Z8-18'), {
...
/* CHANGES map.js to playhouse_map.js 
   Change symbols, labels layers from zoom Z6-16 versions to Z8-18 versions
...
*/
  let symbols = L.tileLayer(getREEDLayerURL('EREED_places_geojson_points_Z8-18'));
  let labels = L.tileLayer(getREEDLayerURL('EREED_places_geojson_labels_Z8-18'));
/* CHANGES map.js to playhouse_map.js 
	Remove the two historical diocese layers 
...
*/
/* CHANGES map.js to playhouse_map.js 
	Add three new layers: sewers, parishes, liberties-and-manors
*/
  let sewers = L.tileLayer(getREEDLayerURL('EREED_gis_Rose_sewersonly'));
  let parishes = L.tileLayer(getREEDLayerURL('EREED_gis_Rose_Parishes_wlabels'));
  let liberties = L.tileLayer(getREEDLayerURL('EREED_gis_Rose_Liberties_purple'));
...
/* CHANGES map.js to playhouse_map.js 
	Remove from Overlays the two historical diocese layers     
    'Historical dioceses before 1541': dioceses_pre,
    'Historical dioceses 1541 and after': dioceses_post
*/
/* CHANGES map.js to playhouse_map.js 
Add to Overlays the three new layers: sewers, parishes, liberties-and-manors
*/
	'Sewers near Playhouses': sewers,
 ...
 */
 /* CHANGES map.js to playhouse_map.js 
 Change initialZoom, minZoom from 6 to 8, change maxZoom from 16 to 18
 */
function makeMap() {
  let initialZoom = 8;
  let minZoom = 8;
