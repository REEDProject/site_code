...
function generateLegend() {
    ...
    const collapsedLegend = jQ('<img>').attr('src', '../../assets/images/map/legendicon.png').css('width', '50px');
    const expandedLegend = jQ('<img>').attr('src', '../../assets/images/map/timeline-legend.png').css('width', '150px');
...
function getExpandedEventRecord(events, eventID) {
    ...
    const recordTitles = normalizeToArray(event.record_title);
