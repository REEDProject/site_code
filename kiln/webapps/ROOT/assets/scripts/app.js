...
! function(e, t) {
    ...
    function r() {
        U.removeEventListener("DOMContentLoaded", r), e.removeEventListener("load", r), se.ready()
    }
    ...
    function _(e) {
        var t = U,
            n = Ye[e];
        return n || (n = x(e, t), "none" !== n && n || (Ke = (Ke || se("<iframe frameborder='0' width='0' height='0'/>")).appendTo(t.documentElement), t = Ke[0].contentDocument, t.write(), t.close(), n = x(e, t), Ke.detach()), Ye[e] = n), n
    }

    function F(e, t, n) {
        var i, o, s, r, a = e.style;
        return n = n || Xe(e), r = n ? n.getPropertyValue(t) || n[t] : void 0, "" !== r && void 0 !== r || se.contains(e.ownerDocument, e) || (r = se.style(e, t)), n && !ie.pixelMarginRight() && Ue.test(r) && Ge.test(t) && (i = a.width, o = a.minWidth, s = a.maxWidth, a.minWidth = a.maxWidth = a.width = r, r = n.width, a.width = i, a.minWidth = o, a.maxWidth = s), void 0 !== r ? r + "" : r
    }
    ...
    function j(e, t, n) {
        var i, o, s = 0,
            ...
            c = u.props;
        for (H(c, u.opts.specialEasing); s < r; s++)
    ...
    var ce = function(e) {
            ...
            if (!i && ((t ? t.ownerDocument || t : N) !== S && O(t), t = t || S, P)) {
                if (11 !== m && (u = ve.exec(e)))
                    if (o = u[1]) {
                        ...
                        } else if (p && (r = p.getElementById(o)) && H(t, r) && r.id === o) return n.push(r), n
                    } else {
                    ...
                    if (1 !== m) p = t, h = e;
                        ...
                        for ((a = t.getAttribute("id")) ? a = a.replace(be, "\\$&") : t.setAttribute("id", a = j), d = _(e), s = d.length, l = fe.test(a) ? "#" + a : "[id='" + a + "']"; s--;) d[s] = l + " " + f(d[s]);
        ...
        function y(e) {
            for (var t, n, i, o = e.length, s = $.relative[e[0].type], r = s || $.relative[" "], a = s ? 1 : 0, l = h(function(e) {
                    return e === t
                }, r, !0), u = h(function(e) {
                    return ee(t, e) > -1
                ...
                if (n = $.relative[e[a].type]) c = [h(p(c), n)];
                    ...
                    if (n = $.filter[e[a].type].apply(null, e[a].matches), n[j]) {
            ...
            var o = n.length > 0,
                ...
                r = function(i, r, a, l, u) {
                    var c, d, f, h = 0,
                        ...
                        C = b.length;
                    for (u && (E = r === S || r || u); p !== C && null != (c = b[p]); p++) {
                        if (s && c) {
        ...
        var w, C, $, k, x, _, F, T, E, z, A, O, S, D, P, R, q, L, H, j = "sizzle" + 1 * new Date,
            N = e.document,
            M = 0,
            I = 0,
            B = n(),
        ...
        try {
            V.apply(U = J.call(N.childNodes), N.childNodes), U[N.childNodes.length].nodeType
        } catch (ke) {
            V = {
        ...
        C = t.support = {}, x = t.isXML = function(e) {
            ...
            return i !== S && 9 === i.nodeType && i.documentElement ? (S = i, D = S.documentElement, P = !x(S), (n = S.defaultView) && n.top !== n && (n.addEventListener ? n.addEventListener("unload", $e, !1) : n.attachEvent && n.attachEvent("onunload", $e)), C.attributes = o(function(e) {
            ...
            })), (C.matchesSelector = ge.test(L = D.matches || D.webkitMatchesSelector || D.mozMatchesSelector || D.oMatchesSelector || D.msMatchesSelector)) && o(function(e) {
                C.disconnectedMatch = L.call(e, "div"), L.call(e, "[s!='']:x"), q.push("!=", se)
            }), R = R.length && new RegExp(R.join("|")), q = q.length && new RegExp(q.join("|")), t = ge.test(D.compareDocumentPosition), H = t || ge.test(D.contains) ? function(e, t) {
                ...
                return n ? n : (n = (e.ownerDocument || e) === (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1, 1 & n || !C.sortDetached && t.compareDocumentPosition(e) === n ? e === S || e.ownerDocument === N && H(N, e) ? -1 : t === S || t.ownerDocument === N && H(N, t) ? 1 : z ? ee(z, e) - ee(z, t) : 0 : 4 & n ? -1 : 1)
            } : function(e, t) {
                if (e === t) return A = !0, 0;
                var n, i = 0,
                    o = e.parentNode,
                    ...
                    a = [e],
                    l = [t];
                if (!o || !s) return e === S ? -1 : t === S ? 1 : o ? -1 : s ? 1 : z ? ee(z, e) - ee(z, t) : 0;
                if (o === s) return r(e, t);
            ...
            return (e.ownerDocument || e) !== S && O(e), H(e, t)
        }, t.attr = function(e, t) {
            ...
            var t, n = [],
                i = 0,
                o = 0;
            if (A = !C.detectDuplicates, z = !C.sortStable && e.slice(0), e.sort(K), A) {
                    ...
                    return 1 === i && 0 === o ? function(e) {
                        ...
                        if (g) {
                            ...
                            if (p = [r ? g.firstChild : g.lastChild], r && y) {
                                for (f = g, d = f[j] || (f[j] = {}), c = d[f.uniqueID] || (d[f.uniqueID] = {}), u = c[e] || [], h = u[0] === M && u[1], b = h && u[2], f = h && g.childNodes[h]; f = ++h && f && f[m] || (b = h = 0) || p.pop();)
                                    if (1 === f.nodeType && ++b && f === t) {
                                        c[e] = [M, h, b];
                                        break
                                    }
                            } else if (y && (f = t,
                                    d = f[j] || (f[j] = {}), c = d[f.uniqueID] || (d[f.uniqueID] = {}), u = c[e] || [], h = u[0] === M && u[1], b = h), b === !1)
                                for (;
                                    (f = ++h && f && f[m] || (b = h = 0) || p.pop()) && ((a ? f.nodeName.toLowerCase() !== v : 1 !== f.nodeType) || !++b || (y && (d = f[j] || (f[j] = {}), c = d[f.uniqueID] || (d[f.uniqueID] = {}), c[e] = [M, b]), f !== t)););
        ...
        return d.prototype = $.filters = $.pseudos, $.setFilters = new d, _ = t.tokenize = function(e, n) {
            ...
            for (a = e, l = [], u = $.preFilter; a;) {
                ...
                for (r in $.filter) !(o = he[r].exec(a)) || u[r] && !(o = u[r](o)) || (i = o.shift(), s.push({
                    value: i,
                    type: r,
                    matches: o
                }), a = a.slice(i.length));
            ...
            if (n = n || [], 1 === d.length) {
                if (s = d[0] = d[0].slice(0), s.length > 2 && "ID" === (r = s[0]).type && C.getById && 9 === t.nodeType && P && $.relative[s[1].type]) {
                    if (t = ($.find.ID(r.matches[0].replace(we, Ce), t) || [])[0], !t) return n;
                    u && (t = t.parentNode), e = e.slice(s.shift().value.length)
                }
                for (o = he.needsContext.test(e) ? 0 : s.length; o-- && (r = s[o], !$.relative[a = r.type]);)
                    if ((l = $.find[a]) && (i = l(r.matches[0].replace(we, Ce), ye.test(s[0].type) && c(t.parentNode) || t))) {
                        if (s.splice(o, 1), e = i.length && f(s), !e) return V.apply(n, i), n;
                        break
                    }
            }
            return (u || F(e, d))(i, t, !P, n, !t || ye.test(e) && c(t.parentNode) || t), n
        }, C.sortStable = j.split("").sort(K).join("") === j, C.detectDuplicates = !!A, O(), C.sortDetached = o(function(e) {
    ...
    se.fn.ready = function(e) {
        ...
        return $e || ($e = se.Deferred(), "complete" === U.readyState || "loading" !== U.readyState && !U.documentElement.doScroll ? e.setTimeout(se.ready) : (U.addEventListener("DOMContentLoaded", r), e.addEventListener("load", r))), $e.promise(t)
    }, se.ready.promise();
    var ke = function Wt(e, t, n, i, o, s, r) {
            var a = 0,
                l = e.length,
                u = null == n;
            if ("object" === se.type(n)) {
    ...
    se.extend({
        ...
        data: function Qt(e, t) {
            ...
            return "object" === ("undefined" == typeof e ? "undefined" : _typeof(e)) ? this.each(function() {
                ...
                var n, i;
                if (o && void 0 === t) {
                    if (n = Fe.get(o, e) || Fe.get(o, e.replace(Ee, "-$&").toLowerCase()), void 0 !== n) return n;
    ...
    se.event = {
        ...
        add: function(e, t, n, i, o) {
            ...
            if (g)
                for (n.handler && (s = n, n = s.handler, o = s.selector), n.guid || (n.guid = se.guid++), (l = g.events) || (l = g.events = {}), (r = g.handle) || (r = g.handle = function(t) {
                    ...
                    }), t = (t || "").match(Ce) || [""], u = t.length; u--;) a = Ne.exec(t[u]) || [], h = m = a[1], p = (a[2] || "").split(".").sort(), h && (d = se.event.special[h] || {}, h = (o ? d.delegateType : d.bindType) || h, d = se.event.special[h] || {}, c = se.extend({
                    type: h,
                    origType: m,
                    data: i,
                    handler: n,
        ...
        remove: function(e, t, n, i, o) {
            ...
            if (g && (l = g.events)) {
                for (t = (t || "").match(Ce) || [""], u = t.length; u--;)
                    if (a = Ne.exec(t[u]) || [], h = m = a[1], p = (a[2] || "").split(".").sort(), h) {
        ...
        fix: function(e) {
            ...
            var t, n, i, o = e.type,
                s = e,
                r = this.fixHooks[o];
            for (r || (this.fixHooks[o] = r = je.test(o) ? this.mouseHooks : He.test(o) ? this.keyHooks : {}), i = r.props ? this.props.concat(r.props) : this.props, e = new se.Event(s), t = i.length; t--;) n = i[t], e[n] = s[n];
    ...
    ! function() {
        ...
        var n, i, o, s, r = U.createElement("div"),
    ...
    se.extend({
        ...
        style: function Gt(e, t, n, i) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                var o, s, r, a = se.camelCase(t),
                    Gt = e.style;
                return t = se.cssProps[a] || (se.cssProps[a] = E(a) || a), r = se.cssHooks[t] || se.cssHooks[a], void 0 === n ? r && "get" in r && void 0 !== (o = r.get(e, !1, i)) ? o : Gt[t] : (s = "undefined" == typeof n ? "undefined" : _typeof(n), "string" === s && (o = Ae.exec(n)) && o[1] && (n = u(e, t, o), s = "number"), null != n && n === n && ("number" === s && (n += o && o[3] || (se.cssNumber[a] ? "" : "px")), ie.clearCloneStyle || "" !== n || 0 !== t.indexOf("background") || (Gt[t] = "inherit"), r && "set" in r && void 0 === (n = r.set(e, n, i)) || (Gt[t] = n)), void 0)
            }
        },
        css: function(e, t, n, i) {
            var o, s, r, a = se.camelCase(t);
            return t = se.cssProps[a] || (se.cssProps[a] = E(a) || a), r = se.cssHooks[t] || se.cssHooks[a], r && "get" in r && (o = r.get(e, !0, n)), void 0 === o && (o = F(e, t, i)), "normal" === o && t in tt && (o = tt[t]), "" === n || n ? (s = parseFloat(o), n === !0 || isFinite(s) ? s || 0 : o) : o
        }
        ...
        se.cssHooks[t] = {
            ...
            set: function(e, n, i) {
                ...
                return r && (o = Ae.exec(n)) && "px" !== (o[3] || "px") && (e.style[t] = n, n = se.css(e, t)), z(e, n, r)
            }
        }
    ...
    se.fn.extend({
        addClass: function(e) {
            ...
            if ("string" == typeof e && e)
                for (t = e.match(Ce) || []; n = this[l++];)
                    if (o = N(n), i = 1 === n.nodeType && (" " + o + " ").replace(ft, " ")) {
        ...
        toggleClass: function(e, t) {
            ...
            return "boolean" == typeof t && "string" === n ? t ? this.addClass(e) : this.removeClass(e) : se.isFunction(e) ? this.each(function(n) {
                ...
                else void 0 !== e && "boolean" !== n || (t = N(this), t && _e.set(this, "__className__", t), this.setAttribute && this.setAttribute("class", t || e === !1 ? "" : _e.get(this, "__className__") || ""))
            })
        },
        hasClass: function(e) {
            var t, n, i = 0;
            for (t = " " + e + " "; n = this[i++];)
                if (1 === n.nodeType && (" " + N(n) + " ").replace(ft, " ").indexOf(t) > -1) return !0;
            return !1
        }
    });
    var ht = /\r/g,
    ...
    se.extend(se.event, {
        trigger: function(t, n, i, o) {
            var s, r, a, l, u, c, d, f = [i || U],
                h = ne.call(t, "type") ? t.type : t,
                p = ne.call(t, "namespace") ? t.namespace.split(".") : [];
            if (r = a = i = i || U, 3 !== i.nodeType && 8 !== i.nodeType && !mt.test(h + se.event.triggered) && (h.indexOf(".") > -1 && (p = h.split("."), h = p.shift(), p.sort()), u = h.indexOf(":") < 0 && "on" + h, t = t[se.expando] ? t : new se.Event(h, "object" === ("undefined" == typeof t ? "undefined" : _typeof(t)) && t), t.isTrigger = o ? 2 : 3, t.namespace = p.join("."), t.rnamespace = t.namespace ? new RegExp("(^|\\.)" + p.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = i), n = null == n ? [t] : se.makeArray(n, [t]), d = se.event.special[h] || {}, o || !d.trigger || d.trigger.apply(i, n) !== !1)) {
                ...
                for (s = 0;
                    (r = f[s++]) && !t.isPropagationStopped();) t.type = s > 1 ? l : d.bindType || h, c = (_e.get(r, "events") || {})[t.type] && _e.get(r, "handle"), c && c.apply(r, n), c = u && r[u], c && c.apply && xe(r) && (t.result = c.apply(r, n), t.result === !1 && t.preventDefault());
                return t.type = h, o || t.isDefaultPrevented() || d._default && d._default.apply(f.pop(), n) !== !1 || !xe(i) || u && se.isFunction(i[h]) && !se.isWindow(i) && (a = i[u], a && (i[u] = null), se.event.triggered = h, i[h](), se.event.triggered = void 0, a && (i[u] = a)), t.result
            }
        },
    ...
    var bt = /#.*$/,
        ...
        Ft = {},
        Tt = "*/".concat("*"),
        Et = U.createElement("a");
    Et.href = gt.href, se.extend({
        active: 0,
        lastModified: {},
        etag: {},
        ajaxSettings: {
        ...
        ajax: function(t, n) {
            function i(t, n, i, a) {
                var u, d, y, b, C, k = n;
                2 !== w && (w = 2, l && e.clearTimeout(l), o = void 0, r = a || "", $.readyState = t > 0 ? 4 : 0, u = t >= 200 && t < 300 || 304 === t, i && (b = W(f, $, i)), b = Q(f, b, $, u), u ? (f.ifModified && (C = $.getResponseHeader("Last-Modified"), C && (se.lastModified[s] = C), C = $.getResponseHeader("etag"), C && (se.etag[s] = C)), 204 === t || "HEAD" === f.type ? k = "nocontent" : 304 === t ? k = "notmodified" : (k = b.state, d = b.data, y = b.error, u = !y)) : (y = k, !t && k || (k = "error", t < 0 && (t = 0))), $.status = t, $.statusText = (n || k) + "", u ? m.resolveWith(h, [d, k, $]) : m.rejectWith(h, [$, k, y]), $.statusCode(v), v = void 0, c && p.trigger(u ? "ajaxSuccess" : "ajaxError", [$, f, u ? d : y]), g.fireWith(h, [$, k]), c && (p.trigger("ajaxComplete", [$, f]), --se.active || se.event.trigger("ajaxStop")))
            }
            ...
            if (m.promise($).complete = g.add, $.success = $.done, $.error = $.fail, f.url = ((t || f.url || gt.href) + "").replace(bt, "").replace(xt, gt.protocol + "//"), f.type = n.method || n.type || f.method || f.type, f.dataTypes = se.trim(f.dataType || "*").toLowerCase().match(Ce) || [""], null == f.crossDomain) {
                u = U.createElement("a");
                try {
            ...
            if (f.data && f.processData && "string" != typeof f.data && (f.data = se.param(f.data, f.traditional)), I(_t, f, n, $), 2 === w) return $;
            c = se.event && f.global, c && 0 === se.active++ && se.event.trigger("ajaxStart"), f.type = f.type.toUpperCase(), f.hasContent = !kt.test(f.type), s = f.url, f.hasContent || (f.data && (s = f.url += (yt.test(s) ? "&" : "?") + f.data, delete f.data), f.cache === !1 && (f.url = wt.test(s) ? s.replace(wt, "$1_=" + vt++) : s + (yt.test(s) ? "&" : "?") + "_=" + vt++)), f.ifModified && (se.lastModified[s] && $.setRequestHeader("If-Modified-Since", se.lastModified[s]), se.etag[s] && $.setRequestHeader("If-None-Match", se.etag[s])), (f.data && f.hasContent && f.contentType !== !1 || n.contentType) && $.setRequestHeader("Content-Type", f.contentType), $.setRequestHeader("Accept", f.dataTypes[0] && f.accepts[f.dataTypes[0]] ? f.accepts[f.dataTypes[0]] + ("*" !== f.dataTypes[0] ? ", " + Tt + "; q=0.01" : "") : f.accepts["*"]);
            for (d in f.headers) $.setRequestHeader(d, f.headers[d]);
            if (f.beforeSend && (f.beforeSend.call(h, $, f) === !1 || 2 === w)) return $.abort();
            C = "abort";
            for (d in {
                    success: 1,
                    error: 1,
            ...
            if (o = I(Ft, f, n, $)) {
                if ($.readyState = 1, c && p.trigger("ajaxSend", [$, f]), 2 === w) return $;
    ...
    return se.noConflict = function(t) {
        return e.$ === se && (e.$ = Nt), t && e.jQuery === se && (e.jQuery = jt), se
    }, t || (e.jQuery = e.$ = se), se
    ...
    function o(e) {
        ...
        if ("pointer" === n && (n = l(e)), g !== n) {
            ...
            !h.hasAttribute("data-whatinput-formtyping") && g && "keyboard" === n && "tab" !== k[t] && ("textarea" === o || "select" === o || "input" === o && v.indexOf(c) < 0) || b.indexOf(t) > -1 || s(n)
        }
        "keyboard" === n && u(t)
    }

    function s(e) {
        g = e, h.setAttribute("data-whatinput", g), $.indexOf(g) === -1 && $.push(g)
    }
    ...
    function u(e) {
        p.indexOf(k[e]) === -1 && k[e] && p.push(k[e])
    }
...
! function(e) {
    ...
    function i(e, t, i, o, s, r) {
        ...
        switch (i) {
            ...
            default:
                return {
                    left: Foundation.rtl() ? l.offset.left - a.width + l.width : l.offset.left + s, top: l.offset.top + l.height + o
                }
        }
    }
    Foundation.Box = {
...
$(document).ready(function() {
    function e(e, t, n, i) {
        n -= 50, $(".footnote-box .heading").html(i), $(".footnote-box").toggleClass("is-open"), $(".footnote-box .footnote-content").html(e), $(".footnote-box").css({
            top: t.top + 30,
            left: t.left + n
        })
    }
    $(document).foundation();
    var t, n;
    if ($(window).width() <= 767 && (t = !0), $(".js-hide").remove(), $(".tooltip-button").on("click", function() {
            $(this).parent().toggleClass("opened")
        }), $(".menu-button").on("click", function() {
            $(".menu-overlay").toggleClass("open"), $(".logo").toggleClass("open "), $(".container").toggleClass("open "), $("header nav").toggleClass("open"), $("footer").toggleClass("open"), $("body").css("top", $("body").scrollTop() * -1), $("body").toggleClass("fixed")
        }), $(".menu-overlay").on("click touchstart touchend ontouchmove ontouchstart ontouchend", function() {
            $(this).removeClass("open "), $(".logo").removeClass("open "), $(".container").removeClass("open "), $("header nav").removeClass("open"), $("footer").removeClass("open"), $("body").removeClass("fixed")
        }), $(".back-to-top").on("click", function(e) {
            e.preventDefault(), $("html, body").animate({
                scrollTop: 0
            }, 1e3)
        }), $(".footnote-box .close").on("click", function() {
            $(this).parent().removeClass("is-open")
        }), $(".view-tags .heading").on("click", function() {
            $(this).next().slideToggle("fast", function() {
                Foundation.reInit("equalizer")
            }), $(this).parent().toggleClass("opened")
        }), $("#contact-form").on("submit", function(e) {
            for (var t, n = $("input, textarea"), i = 0; i < n.length; i++) "" == $(n[i]).val() && ($(n[i]).prev().addClass("failed"), $(n[i]).addClass("failed"), t = !0), "" != $(n[i]).val() && ($(n[i]).prev().removeClass("failed"), $(n[i]).removeClass("failed"));
            return !t || (e.preventDefault(), e.stopPropagation(), !1)
        }), $(".is-dropdown-submenu-parent").on("click", function() {
            $(this).toggleClass("is-active"), $(".is-dropdown-submenu", this).toggleClass("js-dropdown-active")
            ...
            if ("undefined" !== ("undefined" == typeof i ? "undefined" : _typeof(i)) && i !== !1) {
                var n = '<a href="#">Iohn Medcofe</a><br><a href="#">Iohn Medcofe (2nd instance)</a>';
                e(n, $(this).offset(), $(this).width(), "Which term would you like to see?")
            } else e(n, $(this).offset(), $(this).width(), "Glossed Term")
        }), $(".marginalia").on("click", function() {
            var t = $(this).attr("note"),
                n = $(".marginalia-list li[note='" + t + "']").html();
            e(n, $(this).offset(), $(this).width(), "Marginalia")
        }), $(".collation").on("click", function() {
            var t = $(this).attr("note"),
                n = $(".collation-list li[note='" + t + "']").html();
            e(n, $(this).offset(), $(this).width(), "Collation note")
        }), $(".jump-to-filter a").on("click", function(e) {
            e.preventDefault();
            ...
            $(this).closest(".opened").removeClass("opened"), $(this).closest(".filter-content-wrapper").slideToggle()
        }), $(".link-to-instance").on("click", function() {
            var e = $(this).parent().attr("note");
            $("html, body").animate({
                scrollTop: $(".term[note='" + e + "']").offset().top
            }, 1e3)
        }), $("input[name='show-tags']").on("click", function() {
            $(this).is(":checked") ? $("input[name='show-tags']").prop("checked", !0) : $("input[name='show-tags']").prop("checked", !1), $(".tag").toggleClass("activate")
        }), $("input[name='show-terms']").on("click", function() {
            $(this).is(":checked") ? $("input[name='show-terms']").prop("checked", !0) : $("input[name='show-terms']").prop("checked", !1), $(".term").toggleClass("activate")
        }), t) {
        var i = $("header").height();
        $(".container").css("margin-top", i), $("nav").css("width", $(window).width() - 30)
    }
    if ($(".related-entities-table") && (n = $(".related-entities-table").DataTable({
            columnDefs: [{
                targets: 0,
                width: "100%",
                orderable: !1
            ...
            pageLength: 20,
            dom: '<"top entities"i>rt<"bottom entities"<"small-margin-bottom-25">p><"clear">',
            bSort: !1,
            language: {
                paginate: {
                    next: "&gt;",
                    previous: "&lt;",
                    first: '<svg width="12px" class="inline flip" height="13px" viewBox="12 11 12 13" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">\n    <g id="Group-2" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd" transform="translate(12.000000, 12.000000)">\n        <path d="M8.5,7.58416803 C8.5,7.6710088 8.46659961,7.74782898 8.39979943,7.81462916 L7.89879779,8.3156314 C7.83199701,8.38243158 7.75517684,8.41583137 7.66833667,8.41583137 C7.58149649,8.41583137 7.50467572,8.38243158 7.43787554,8.3156314 L3.5,4.37775526 L-0.43787554,8.3156314 C-0.504675719,8.38243158 -0.581495895,8.41583137 -0.668336666,8.41583137 C-0.755176839,8.41583137 -0.831997015,8.38243158 -0.898797193,8.3156314 L-1.39979943,7.81462916 C-1.46659961,7.74782898 -1.5,7.6710088 -1.5,7.58416803 C-1.5,7.49732786 -1.46659961,7.42050769 -1.39979943,7.35370751 L3.26953887,2.6843686 C3.33633965,2.61756842 3.41315983,2.58416863 3.5,2.58416863 C3.58684017,2.58416863 3.66366095,2.61756842 3.73046113,2.6843686 L8.39979943,7.35370751 C8.46659961,7.42050769 8.5,7.49732786 8.5,7.58416803 L8.5,7.58416803 Z" id="Shape-Copy-5" fill="#008281" transform="translate(3.500000, 5.500000) scale(-1, 1) rotate(-90.000000) translate(-3.500000, -5.500000) "></path>\n        <path d="M9.41666667,0.25 L9.41666667,10.75" id="Path-2" stroke="#008281" stroke-width="1.25"></path>\n    </g>\n    <style>\n        #Path-2 {\n         stroke: "#008281";\n        }\n        .unavailable #Path-2, .unavailable #Shape-Copy-5 {\n        stroke: #E5E7E9;\n        fill: #E5E7EA;\n        }\n    </style>\n</svg>\n',
                    last: '<svg width="12px" class="inline" height="13px" viewBox="12 11 12 13" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">\n    <g id="Group-2" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd" transform="translate(12.000000, 12.000000)">\n        <path d="M8.5,7.58416803 C8.5,7.6710088 8.46659961,7.74782898 8.39979943,7.81462916 L7.89879779,8.3156314 C7.83199701,8.38243158 7.75517684,8.41583137 7.66833667,8.41583137 C7.58149649,8.41583137 7.50467572,8.38243158 7.43787554,8.3156314 L3.5,4.37775526 L-0.43787554,8.3156314 C-0.504675719,8.38243158 -0.581495895,8.41583137 -0.668336666,8.41583137 C-0.755176839,8.41583137 -0.831997015,8.38243158 -0.898797193,8.3156314 L-1.39979943,7.81462916 C-1.46659961,7.74782898 -1.5,7.6710088 -1.5,7.58416803 C-1.5,7.49732786 -1.46659961,7.42050769 -1.39979943,7.35370751 L3.26953887,2.6843686 C3.33633965,2.61756842 3.41315983,2.58416863 3.5,2.58416863 C3.58684017,2.58416863 3.66366095,2.61756842 3.73046113,2.6843686 L8.39979943,7.35370751 C8.46659961,7.42050769 8.5,7.49732786 8.5,7.58416803 L8.5,7.58416803 Z" id="Shape-Copy-5" fill="#008281" transform="translate(3.500000, 5.500000) scale(-1, 1) rotate(-90.000000) translate(-3.500000, -5.500000) "></path>\n        <path d="M9.41666667,0.25 L9.41666667,10.75" id="Path-2" stroke="#008281" stroke-width="1.25"></path>\n    </g>\n    <style>\n        #Path-2 {\n         stroke: "#008281";\n        }\n        .unavailable #Path-2, .unavailable #Shape-Copy-5 {\n        stroke: #E5E7E9;\n        fill: #E5E7EA;\n        }\n    </style>\n</svg>\n'
                },
                info: "_START_ - _END_ of _TOTAL_ records shown "
            },
        ...
        /********      Search the Records DataTable      ********/
        /********                                        ********/
        /********************************************************/

        $(".main-table") && (n = $("#table").DataTable({
            columnDefs: [
                {
                    targets: 0,
                    width: "8%",
            ...
            pageLength: 20,
            dom: '<"row"<"#top-paginate"p<"page-input">>>'
                + '<"top"i<"view-records">>'
                + 'rt'
                + '<"bottom"<"view-records small-margin-bottom-25">><"#bottom-paginate"p<"page-input">>'
                + '<"clear">',
            order: [
                [2, "asc"],
                [3, "asc"],
        ...
        $(".go-page-button").on("click", function(e) {
            e.preventDefault()
            const pageNum = $(this).siblings(".page-input-field").val();
        ...
        $("#checkbox-toggle").on("click", function(e) {
            e.preventDefault(), $("#checkbox-options").toggle(), $("#checkbox-options li").toggleClass("hide")
        }),
        $("#checkbox-options li").on("click", function() {
            var e = !1;
            "all" == $(this).data("option") && (e = !0);
            var t = n.rows({
                search: "applied"
            }).nodes();
            $('input[type="checkbox"]', t).prop("checked", e), $("#table-select-all").prop("checked", e), $("#checkbox-options").hide(), $("#checkbox-options li").toggleClass("hide")
        }),
        $(".result-num").click(function() {
            $(window).scrollTo(document.getElementById($(this).data("record")), 600)
        }),
        $("#table tbody").on("change", 'input[type="checkbox"]', function() {
            if (!this.checked) {
                var e = $("#table-select-all").get(0);
                e && e.checked && "indeterminate" in e && (e.indeterminate = !0)
            }
        }),
        $("#frm-table").on("submit", function(e) {
            var t = this;
            n.$('input[type="checkbox"]').each(function() {
                $.contains(document, this) || this.checked && $(t).append($("<input>").attr("type", "hidden").attr("name", this.name).val(this.value))
            })
        })),
        $("#result-table")) { $("#result-table").DataTable({
            columnDefs: [{
                targets: 0,
                searchable: !0,
                orderable: !1,
    ...
    if ($(".filter-head").on("click", function() {
            $(this).parent().toggleClass("opened"), $(this).next().slideToggle(200)
        }), $(".to-top-button").on("click", function(e) {
            e.preventDefault(), $(window).scrollTo(0, 600)
