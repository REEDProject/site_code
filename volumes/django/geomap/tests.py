...
class PlaceModelTests(TestCase):
    ...
    def _create_place(self, name, coordinates, container=None,
                      placeholder=None):
        place = Place(name=name, coordinates=coordinates, container=container,
    ...
    def test_get_actual_coordinates_with_placeholder_coords(self):
        ...
        expected_coordinates = GEOSGeometry('POINT(3 4)')
        place = self._create_place('Place', expected_coordinates, None,
                                   'POINT(4 5)')
        actual_coordinates = place.get_actual_coordinates()
        self.assertEqual(actual_coordinates, expected_coordinates)
    ...
    def test_get_actual_coordinates_with_container_placeholder_coords(self):
        ...
        expected_coordinates = GEOSGeometry('POINT(3 4)')
        container = self._create_place('Container', 'POINT(2 3)',
                                       None, expected_coordinates)
    ...
    def test_get_actual_coordinates_with_container_container_coords(self):
        ...
        expected_coordinates = GEOSGeometry('POINT(3 4)')
        gp_container = self._create_place('Grandparent Container', None, None,
...
class PlaceDetailViewTests(TestCase):
    ...
    def _compare_json(self, response, expected):
        ...
        expected['crs'] = {'properties': {'name': 'EPSG:4326'},
                           'type': 'name'}
    ...
    def _create_place_json(self, place):
        ...
        geojson = {
            ...
            'properties': {
                ...
                'patrons_place_code': place.patrons_place_code,
                'patrons_place_type': place.patrons_place_type,
                'pk': str(place.id),
