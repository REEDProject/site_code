...
""" % {
        ...
        expected_xml = (
            '<collection xmlns="http://eats.artefact.org.nz/ns/eatsml/"></collection>'
        )
...
""" % {
        ...
        # An import will not change an existing authority's references.
        self.assertFalse(
            entity_relationship_type in authority.get_entity_relationship_types()
        )
        self.assertEqual(
            entity_relationship_type.get_admin_forward_name(), "is child of"
        )
        self.assertEqual(
            entity_relationship_type.get_admin_reverse_name(), "is parent of"
        )
        expected_xml = """
<collection xmlns="http://eats.artefact.org.nz/ns/eatsml/">
  <entity_relationship_types>
  ...
  <entities>
    <entity xml:id="entity-1">
      <existences>
        ...
        self.assertRaises(
            EATSMLException, self.importer.import_xml, import_xml, self.admin
        )
...
""" % {
            "authority1": authority1.get_id(),
            "authority2": authority2.get_id(),
  ...
  <entities>
    ...
    <entity xml:id="entity-2">
      <entity_relationships>
        ...
        self.assertEqual(assertion.entity_relationship_type, entity_relationship_type)
...
<collection xmlns="http://eats.artefact.org.nz/ns/eatsml/">
  ...
  <entities>
    ...
    def test_import_new_entity_name(self):
        ...
        authority.set_name_part_types([given_name_part_type, family_name_part_type])
  ...
  <entities>
    <entity xml:id="entity-1">
      <subject_identifiers>
        ...
        self.assertEqual(assertion.subject_identifier, "http://www.example.org/test/")
        self.assertEqual(assertion.authority, authority)
        expected_xml = """
<collection xmlns="http://eats.artefact.org.nz/ns/eatsml/">
  <authorities>
  ...
  <entities>
    <entity xml:id="entity-1">
      <existences>
        ...
        self.assertEqual(existence.authority, authority)
        self.assertEqual(
            date.assembled_form, "1 January 2000 \N{EN DASH} c.21 March 2010?"
        )
