...
class NoteAddViewTestCase(ViewTestCase):
    ...
    def test_authentication_assertion(self):
        ...
        url = reverse(
            "eats-pa-note-add",
            kwargs={"entity_id": entity.get_id(), "assertion_id": existence.get_id()},
        )
    ...
    def test_non_matching_pa_note_add(self):
        ...
        self.app.get(
            reverse("eats-pa-note-add", kwargs=url_args), status=404, user="user"
        )
    ...
    def test_non_matching_date_note_add(self):
        ...
        self.app.get(
            reverse("eats-date-note-add", kwargs=url_args), status=404, user="user"
        )
    ...
    def test_wrong_assertion_type(self):
        ...
        notes."""
        entity = self.tm.create_entity(self.authority)
        note_pa = entity.create_note_property_assertion(self.authority, "Test", False)
        url_args = {"entity_id": entity.get_id(), "assertion_id": note_pa.get_id()}
        self.app.get(
            reverse("eats-pa-note-add", kwargs=url_args), status=404, user="user"
        )
    ...
    def _post_valid_pa_note(self, submit_name):
        ...
        url_args = {"entity_id": entity.get_id(), "assertion_id": existence.get_id()}
