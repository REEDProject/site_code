...
class TestDocumentConverter (TestCase):
    ...
    def test_acute (self):
        for vowel in self.vowels:
            ...
            self.assertEqual(self._convert(text), expected)
    ...
    def test_heading (self):
        ...
        expected = '<head type="main"><placeName>BPA</placeName> <date>1532</date> DOU2</head>'
        self.assertEqual(self._convert(text), expected)
    ...
    def test_interpolation (self):
        ...
        self.assertEqual(self._convert(nested_text), nested_expected)
    ...
    def test_subheading (self):
        ...
        expected = '<head type="sub"> f.40* <hi rend="italic">(12 January) (Fortune: Warrant)</hi></head>'
        self.assertEqual(self._convert(text), expected)
